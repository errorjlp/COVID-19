...
if __name__ == '__main__':
    ...
    today_df = pd.DataFrame(data)[['name']]
    ...
    existData = confirmData - deadData - healData
    ...
    today_df['exist'] = existData

    # 调整列的顺序
    today_df = today_df[['name', 'confirm',  'exist', 'dead', 'heal']]
    print(today_df)
    # 修改列名
    ...
    pd.io.sql.to_sql(today_df, '163Pdata', engine, schema='COVID19', if_exists='append', index=False)
    engine.dispose()
