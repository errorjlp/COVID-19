...
if __name__ == '__main__':
    ...
    # print(status)
    #省份数据
    data = data_json['data']['areaTree'][2]['children'][10]['children']
    ...
    # 调整列的顺序
    today_df = today_df[['name', 'confirm']]
    print(today_df)
    # 修改列名
    ...
    pd.io.sql.to_sql(today_df, 'city', engine, schema='COVID19', if_exists='append', index=False)
    engine.dispose()
